...
func (e *Exporter) UploadObs() {
	...
	uid := uuid.NewString()
	e.emailUrl, e.err = e.ctx.HwObsClient.PutObjectAndSetMetadata(e.buf, fmt.Sprintf("project-%s.%s", uid, REPORT_FORMAT_XLSX), ContentTypes[REPORT_FORMAT_XLSX], &obs.SetObjectMetaData{
